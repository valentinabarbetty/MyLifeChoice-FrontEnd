...
export const administracionEndingDialogues = [
  {
    speaker: "Raquelle",
    text: "Excelente trabajo. Has demostrado habilidades básicas de organización administrativa.",
    animation: "talking",
  },
  {
    speaker: "Raquelle",
    text: "La administración requiere análisis, estrategia y toma de decisiones constante.",
    animation: "talking",
  },
  {
    speaker: "Raquelle",
    text: "Tus decisiones impactaron directamente en el estado de la empresa.",
    animation: "talking",
  },
  {
    speaker: "Raquelle",
    text: "¡Felicidades! Has terminado la experiencia en la carrera de Administración.",
    animation: "clap",
  },
];